...
use Anezi\Bundle\BootstrapBundle\Twig\Node\CommentNode;
...
class CommentTokenParser extends \Twig_TokenParser
{
    ...
    public function parse(\Twig_Token $token)
    {
        ...
        return new CommentNode($body, $domain, null, $vars, $locale, $lineno, $this->getTag());
    }

    public function decideTransFork($token)
    {
        return $token->test(array('endcomment'));
    }
